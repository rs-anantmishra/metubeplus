...
const GetVideoInformationById string = `Select V.Title, V.PlayListId, P.Title, V.PlaylistVideoIndex, C.Name as 'Channel', D.Domain, P.Title as 'PlaylistTitle', YoutubeVideoId, V.WebpageURL, P.ChannelId
										FROM tblVideos V 
